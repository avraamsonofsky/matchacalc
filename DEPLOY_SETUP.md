...
**Стагинг на поддомене:** пошаговая инструкция в [STAGING_SUBDOMAIN.md](STAGING_SUBDOMAIN.md). Пример конфига Nginx — [nginx-staging.conf.example](nginx-staging.conf.example).
